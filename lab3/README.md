...
## 14. Що ще треба додати вручну

У звіті вже підготовлено основний зміст. Від тебе за потреби залишиться лише:

- вписати точну назву дисципліни;
- вписати ПІБ учасників команди;
- вписати номер групи;
- за бажанням перенести цей текст у Word / Google Docs / PDF формат для здачі.
